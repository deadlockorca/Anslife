...
export const PRODUCTS_AND_SOLUTIONS_MENU: MenuChildItem[] = [
  ...
  {
    label: 'Giải pháp lưu kho tại Việt Nam',
...
export const TOP_MENU: TopMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Triết lý sản xuất', path: '/about-anslife/production-philosophy' },
      { label: 'Cơ cấu tổ chức', path: '/about-anslife/organization' },
      { label: 'Đội ngũ', path: '/about-anslife/team' },
      { label: 'Hệ thống toàn cầu', path: '/global-network' },
      { label: 'Trách nhiệm xã hội', path: '/scholarship-community' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      { label: 'Mạng lưới nhà máy', path: '/manufacturing-ecosystem/production-system' },
      { label: 'Nhà máy ANSLIFE', path: '/manufacturing-ecosystem/anslife-factory' },
      { label: 'Nhà máy vệ tinh', path: '/manufacturing-ecosystem/satellite-factories' },
      { label: 'Công suất sản xuất', path: '/manufacturing-ecosystem/production-capacity' },
      {
        label: 'Phát triển sản phẩm',
        path: '/manufacturing-ecosystem/product-development-capability',
      },
      { label: 'Nguyên liệu & Chuỗi cung ứng', path: '/manufacturing-ecosystem/raw-material-zone' },
      { label: 'Thiết bị & công nghệ', path: '/manufacturing-ecosystem/equipment-technology' },
      { label: 'QC & Đóng gói', path: '/quality-control' },
      {
        label: 'Tiêu chuẩn & chứng chỉ',
        path: '/manufacturing-ecosystem/standards-certificates',
      },
      { label: 'Thị trường xuất khẩu', path: '/manufacturing-ecosystem/export-markets' },
    ],
  },
  {
    label: 'Dịch vụ OEM/ODM',
    path: '/manufacturing-ecosystem/custom-production-oem-odm',
    children: [
      { label: 'Dịch vụ OEM', path: '/manufacturing-ecosystem/custom-production-oem-odm' },
      { label: 'Dịch vụ ODM', path: '/manufacturing-ecosystem/custom-production-oem-odm' },
      { label: 'Thiết kế theo yêu cầu', path: '/manufacturing-ecosystem/custom-production-oem-odm' },
      { label: 'Phát triển mẫu', path: '/manufacturing-ecosystem/sample-development' },
      { label: 'Quy trình đặt hàng', path: '/commercial-process/order-flow' },
      { label: 'Incoterms', path: '/commercial-process/incoterms' },
      { label: 'Thanh toán', path: '/commercial-process/payment' },
  ...
  },
  {
    ...
    children: [
      { label: 'Lưu kho tại Việt Nam', path: '/commercial-process/vietnam-supply-hub' },
      { label: 'Phòng mẫu chuẩn đối tác', path: '/commercial-process/partner-standard-room' },
      {
        label: 'Quản lý mẫu & tiêu chuẩn',
      ...
      { label: 'QC trước xuất hàng', path: '/quality-control/pre-shipment-inspection' },
      { label: 'Đóng gói xuất khẩu', path: '/manufacturing-ecosystem/packaging' },
      { label: 'Gom container / LCL', path: '/commercial-process/export-consolidation' },
      { label: 'Hỗ trợ chứng từ', path: '/commercial-process/documentation-support' },
    ],
  },
  {
    label: 'Dự án',
  ...
  productSolutions: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Vật liệu mút & bọc',
        description: '',
      },
      {
        id: 'rattan-bamboo-materials',
        title: 'Vật liệu mây tre',
        description: '',
      },
      {
